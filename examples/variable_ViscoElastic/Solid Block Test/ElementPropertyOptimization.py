...
class ElementPropertyOptimization:
    def __init__(self):
        ...
        # Change name of input and output file as needed.
        self.input_mesh = './solidTest_3_Seeded_3.exo'
        if self.writeOutput:
          self.output_file = 'output_solidTest_3_Seeded_1_00.exo'

        self.quad_rule = QuadratureRule.create_quadrature_rule_on_triangle(degree=2)

        # Ensure that the nodesets are named properly according to mesh convention
        self.ebcs = [
