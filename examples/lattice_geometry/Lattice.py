...
class Lattice(MeshFixture):
    ...
    def setUp(self):
        ...
        self.mesh = ReadExodusMesh.read_exodus_mesh("./pad.g")
        ...
        ebcs = [
            EssentialBC(nodeSet='nset_pad_bottom', component=0),
            EssentialBC(nodeSet='nset_pad_bottom', component=1),
            EssentialBC(nodeSet='nset_pad_top', component=0),
            EssentialBC(nodeSet='nset_pad_top', component=1)
        ]
    ...
    def write_output(self, Uu, p, step):
        ...
        self.outputForce.append(float(-np.sum(reactions[self.mesh.nodeSets['nset_pad_top'],1])))
    ...
    def get_ubcs(self, p):
        ...
        index = (self.mesh.nodeSets['nset_pad_top'], 1)
