...
class NodalCoordinateOptimization:
    ...
    def __init__(self):
	    ...
	    #EssentialBC(nodeSet='ybottom_right_sideset', component=0),
            #EssentialBC(nodeSet='ybottom_right_sideset', component=1),
            #EssentialBC(nodeSet='ybottom_left_sideset', component=0),
            #EssentialBC(nodeSet='ybottom_left_sideset', component=1),
            #EssentialBC(nodeSet='ytop_sideset', component=0),
            #EssentialBC(nodeSet='ytop_sideset', component=1)
            #EssentialBC(nodeSet='xtop_right_sideset', component=0)
        ]
        ...
        self.input_mesh = './ellipse_test.exo'
        if self.writeOutput:
          self.output_file = 'output_ellipse.exo'
