...
class MaterialPropertiesOptimization:
    ...
    def __init__(self):
        ...
        # self.targetForces = [-25, -50, -75, -100, -75, -50, -25, 0] # target plateau response
        self.targetDisplacement = [1.5, 3, 4.5, 57, 58, 57, 56, 0]
        self.targetForces = [-200, -300, -400, -500, -400, -300, -200, 0] # target plateau response
        ...
        self.mat_model = Neohookean_VariableProps.create_material_model_functions(constant_props)
        ...
        self.props = ReadExodusMesh.read_exodus_mesh_element_properties(self.input_mesh, ['density', 'nu'], blockNum=1)
    ...
    def import_parameters(self, materialProperties=[]):
        ...
        self.elementProperties = np.array(self.props)
